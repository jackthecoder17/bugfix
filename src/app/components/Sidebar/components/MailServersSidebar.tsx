...
const MailServersSidebar = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full justify-between gap-3">
      <Link href={newMailServerRoute} type="button" className="capitalize rounded-[7px] bg-blue text-white  flex justify-center gap-2 items-center px-2 py-2 text-sm">
        <IconContext.Provider value={{ color: "" }}>
          <FaPlus />
        </IconContext.Provider>
        <span>new mail server</span>
      </Link>
