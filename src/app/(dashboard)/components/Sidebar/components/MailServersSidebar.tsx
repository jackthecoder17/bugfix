...
const MailServersSidebar = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full justify-between gap-3">
      <button type="button" onClick={() => dispatch(openServerForm(mode.NEW))} data-tooltip-id={buttonText} className="capitalize rounded-[7px] bg-blue text-white  flex justify-center gap-2 items-center px-2 py-2 text-sm">
